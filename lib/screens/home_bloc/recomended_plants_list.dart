...
import 'package:actividad_04/screens/home_bloc/recomended_plants_card.dart';
...
class RecomendedPlantsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<PlantsCubit, String>(builder: (context, filterText) {
      List<Plant> plants = (filterText.length > 0)
          ? PlantRepository().getFiltered(filterText)
